<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'GetWebSoftware Options', 'redux-framework-demo' ),
        'page_title'           => __( 'GetWebSoftware Options', 'redux-framework-demo' ),
...
'type'=>'media',
'default'=>array(
'url'=>get_template_directory_uri().'/assets/img/danish-image-client-01.png'
)
)
)
));
...
array(
'id'=>'website_help',
'title'=>'Website Help Email',
'type'=>'text'
),
array(
'id'=>'website_copy',
'title'=>'Website Copy Right',
'type'=>'text'
),
array(
'id'=>'website_fb',
